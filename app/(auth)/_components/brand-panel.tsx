...
// Shared brand side for every auth screen (rendered by (auth)/layout.tsx).
export function BrandPanel() {
  return (
    <aside className="relative hidden flex-col justify-between bg-primary p-10 text-primary-foreground md:flex md:w-2/5 lg:w-[38%]">
      <div
      ...
      <span className="relative text-[12px] font-black text-primary-foreground/70">
